...
# Definindo os personagens com nomes simplificados
personagens = [
    "João", "Alexandre", "Ana", "Beatriz", 
    "Gabriel", "Marcos", "Fernanda"
]

# Cenários de morte: onde, como e quando a pessoa morreu
cenarios_de_morte = {
    "Jardim": [
...
# Função para sortear assassino e suspeito falso
...
# Função para mostrar a lista de suspeitos
...
# Função para gerar dicas lógicas com nomes aleatórios
...
# Função para exibir o placar total acumulado
...
def jogo_detetive():
    ...
    boas_vindas()  # Exibe a mensagem de boas-vindas
    ...
    while True:
        ...
        pontuacao_total += pontos  # Soma a pontuação total

        placar_total_acumulado(pontuacao_total)  # Exibe o placar total acumulado
